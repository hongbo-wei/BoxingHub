...
![Computer Vision Punch Classification](static/images/computer-vision-demo.png)
_AI-powered punch classification system identifying a cross punch with 95% confidence_

#### 3. **Chatbot**

- Houses the rule-based chatbot files designed to provide interactive learning experiences for users.

![Boxing Chatbot Interface](static/images/chatbot-demo.png)
_Interactive boxing chatbot providing defense move recommendations and feedback_
...
![My Affirmations Page](static/images/affirmations-demo.png)
_Personalized affirmations generated by AWS LLMs to motivate and inspire users_
